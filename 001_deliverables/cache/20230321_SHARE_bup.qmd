...
all_trips_v5 %>% 
  ...
  labs(y = "Average daily temperature in °F", x = NULL, fill = NULL, title ="usage statistics for members and casual users from october 2021 to 2022") +
...
::: {.column width="30%"}
###### [key insights:]{.smallcaps}

-   usage of the service in general is higher when the weather is good
-   in bad weather, more members use the service than casual users
-   in good weather, casual users outnumber members
:::
:::
